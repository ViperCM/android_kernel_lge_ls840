...
extern int key_logging_count;
extern void slate_send_key_log_packet(unsigned long keycode, unsigned long state);
#endif
#endif
...
// LGE_CHANGE_S [jaekyung83.lee@lge.com] [2011.10.21] [CAYMAN] enable or disable key logging status of slate [START]
			...
			if(key_touch_logging_status == 1)
			{
				...
				{
					slate_send_key_log_packet((unsigned long)KEY_POWER, (unsigned long)1);
				}
				key_logging_count++;
