...
static char *ext3_partitions[] = {"persist", "bsp", "blb", "tombstones", "drm"/*, "fota", "tz_bkp"*/, "system", "cache", "userdata", "lge_rc", "mpt", "grow"};
#else	
...
//LGSI_CHANGE_S : LS840 - Enable Recovery mode FactoryReset :sinjo.mattappallil@lge.com 05-09-2012
...
//#ifdef CONFIG_LGE_K_CAL
module_param_call(lcd_k_cal, write_lcd_k_cal, NULL, NULL,S_IWUSR|S_IRUSR|S_IRGRP|S_IWGRP);	
//#endif
